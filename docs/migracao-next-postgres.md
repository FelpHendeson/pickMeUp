...
- porta no host: `55432`;
- DSN: `postgresql://postgres:postgres@localhost:55432/ascensao_dos_ecos?schema=public`.
...
Se voce ja tiver outro PostgreSQL local na porta 5432, nao ha conflito: este Compose publica o banco na porta 55432.
